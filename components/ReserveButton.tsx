  ...
  return (
    <>
      <button
        ...
        onClick={openModal}
        disabled={disabled}
        className="inline-flex items-center justify-center gap-1.5 rounded-lg bg-zinc-100 px-4 py-2 text-sm font-medium text-zinc-900 transition duration-200 hover:bg-white disabled:cursor-not-allowed disabled:opacity-50"
      >
        Regalaré esto
      </button>
      <ConfirmModal
