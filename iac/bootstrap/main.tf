...
# Account-wide resource, one per AWS account. Already created by dcuero-iac's
# bootstrap; this repo only reads it, never creates/owns/destroys it -- other
# projects' GitHub Actions trust depends on it.
